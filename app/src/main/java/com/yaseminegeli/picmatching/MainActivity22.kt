...
class MainActivity22 : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val binding = ActivityMain22Binding.inflate(layoutInflater)
        ...
        val buttons = arrayOf(
            button1302, button1402, button1502, button1602, button1702, button1802, button1902,
            button2002, button2102, button2202, button2302, button2402,button2502,button2602,button2702,button2802
        )
        ...
        binding.basla202.setOnClickListener {
            mediaPlayer1.start()
        ...
        binding.imageButton02.setOnClickListener(){
        ...
        for (i: Int in 0..15) {
            ...
            buttons[i].setOnClickListener {
                ...
                puan202.text = toplampuan1.toString()
                puan204.text = toplampuan2.toString()
            }
        }
    }
}